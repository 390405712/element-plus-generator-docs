...
import { defineComponent, ref, onMounted, unref, mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext } from "vue";
...
const _sfc_main = Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="自定义列模板" tabindex="-1">自定义列模板 <a class="header-anchor" href="#自定义列模板" aria-label="Permalink to &quot;自定义列模板&quot;">​</a></h1><div class="code"><div class="vp-raw">`);
