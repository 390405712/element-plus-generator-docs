...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    Regexps.forEach((item, index) => {
      formOption.value.push({
        ...
        formItem: {
          ...
          rules: {
            trigger: "change",
            validator: /^[GCDZTSPKXLY1-9]\d{1,4}$/
          }
        },
        control: {
          ...item
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-351438ba>`);
          ...
          return {
            ...
            fn: withCtx((scope, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<div class="examples" data-v-351438ba${_scopeId}><div class="tag-container no-wrap" data-v-351438ba${_scopeId}><div data-v-351438ba${_scopeId}>key</div>`);
                ...
                _push2(`</div><div class="tag-container no-wrap" data-v-351438ba${_scopeId}><div data-v-351438ba${_scopeId}>正则</div>`);
                _push2(ssrRenderComponent(_component_el_tag, {
                ...
                _push2(`</div><div class="tag-container" data-v-351438ba${_scopeId}><div data-v-351438ba${_scopeId}>例子</div><!--[-->`);
                ...
                if (item.control.counterExamples) {
                  _push2(`<div class="tag-container" data-v-351438ba${_scopeId}><div data-v-351438ba${_scopeId}>反例</div><!--[-->`);
...
const index_vue_vue_type_style_index_0_scoped_351438ba_lang = "";
...
const Regexp = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-351438ba"]]);
