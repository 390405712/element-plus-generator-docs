...
const _sfc_main = Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="校验表单" tabindex="-1">校验表单 <a class="header-anchor" href="#校验表单" aria-label="Permalink to &quot;校验表单&quot;">​</a></h1><div class="code"><div class="vp-raw">`);
