...
const _sfc_main = Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="checkbox-多选框" tabindex="-1">Checkbox 多选框 <a class="header-anchor" href="#checkbox-多选框" aria-label="Permalink to &quot;Checkbox 多选框&quot;">​</a></h1><div class="code"><div class="vp-raw">`);
